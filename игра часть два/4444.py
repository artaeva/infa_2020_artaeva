...
class Star:
    ...
    def new(self):
        ...
        self.color = COLORS[randint(0, 5)]
    def draw(self):
        polygon(screen, self.color, ((self.x, self.y - self.r), (self.x+10, self.y-14),
                                     (self.x+int(r*0.95), self.y-int(r*0.3)), (self.x+18, self.y+6),
                                     (self.x+int(r*0.58), self.y+int(r*0.8)), (self.x, self.y+20),
                                     (self.x-int(r*0.58), self.y+int(r*0.8)), (self.x-18, self.y+6),
                                     (self.x-int(r*0.95), self.y-int(r*0.3)), (self.x-10, self.y-14)))
...
finished = False
k = 0
print('введите имя игрока одним словом в кавычках')
name = str(input())
j = randint(2, 5)
balls_list = list()
for i in range(0, j):
