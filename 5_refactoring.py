...
def svet(surface, x, y, width, height):
    ...
    '''
    polygon(surface, (101, 150, 132),
            [(x + 5 + width * 5, y + 140 + height * 160), (x + 5 + width * 145, y + 140 + height * 160),
             (x + 5 + width * 117, y + 140 + height * 110), (x + 5 + width * 33, y + 140 + height * 110)], 0)
    polygon(surface, (100, 100, 239),
            [(x + 5 + width * 33, y + 140 + height * 110), (x + 5 + width * 117, y + 140 + height * 110),
